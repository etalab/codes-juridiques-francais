...
Le contrat de travail temporaire peut être renouvelé [*nombre*] une fois pour une durée déterminée au plus égale à celle de la période initiale. Les conditions de renouvellement sont stipulées dans le contrat ou font l'objet d'un avenant soumis au salarié préalablement au terme initialement prévu.
